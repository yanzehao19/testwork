...
public class Util {
	...
	/**
	 * 获取统一下单签名 @Title: createUnifiedOrderSign @Description: TODO @param @param
	 * unifiedOrder @param @return @return String @throws
	 */
	...
	/**
	 * 获取支付配置 @Title: createPayConfig @Description: TODO @param @param preayId
	 * 统一下单prepay_id @param @return @param @throws Exception @return
	 * JsAPIConfig @throws
	 */
	...
	/**
	 * 微信支付回调页面 @Title: wechatPayNotify @Description: TODO @param @param
	 * request @param @param trade_status @param @param
	 * out_trade_no @param @param trade_no @return void @throws
	 */
	@ResponseBody
	...
	/**
	 * 获取请求参数 @Title: getCallbackParams @Description: TODO @param @param
	 * request @param @return @param @throws Exception @return
	 * Map<String,String> @throws
	 */
	public Map<String, String> getCallbackParams(HttpServletRequest request) throws Exception {
