...
public class Staff extends ArrayList<Position> {
	 ...
	 * Output: [Position: President Person: Me Last The Top, Lonely At,
	 * Position: CTO NullPerson, Position: Marketing Manager NullPerson,
	 * Position: Product Manager NullPerson, Position: Project Lead Person:
	 * Janet Planner The Burbs, Position: Software Engineer Person: Bob Coder
	 * Bright Light City, Position: Software Engineer NullPerson, Position:
	 * Software Engineer NullPerson, Position: Software Engineer NullPerson,
	 * Position: Test Engineer NullPerson, Position: Technical Writer
	 * NullPerson]
	 */// :~
