...
public class AlibabaDOs {
	...
	public String toString() {
		return "AlibabaDOs [variableOfAlibab=" + variableOfAlibab + ", success=" + success + ", conditon=" + conditon
				+ ", key=" + key + ", a=" + a + ", aLo=" + aLo + ", getVariableOfAlibab()=" + getVariableOfAlibab()
				+ ", listVariableOfAlibab()=" + listVariableOfAlibab() + ", countVariableOfAlibab()="
